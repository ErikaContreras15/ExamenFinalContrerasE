...
a persistence unit "ExamenFinalContrerasEPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenFinalContrerasE/pom.xml":
...
artifact ("ExamenFinalContrerasE.war") is already built. You can build
